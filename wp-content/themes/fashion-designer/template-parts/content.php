...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box ">
    <?php $theme_lay = get_theme_mod( 'fashion_designer_blog_layout_option','Default');
    if($theme_lay == 'Default'){ ?>
      <div class="row m-0">
        ...
        <div class="new-text <?php if(has_post_thumbnail()) { ?>col-lg-6 col-md-6" <?php } else { ?>col-lg-12 col-md-12" <?php } ?>>
          ...
          <div class="more-btn">
            <a href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e( 'READ MORE', 'fashion-designer' ); ?><span class="screen-reader-text"><?php esc_html_e( 'READ MORE','fashion-designer' );?></span></a>
          </div>
        </div>
      </div>
