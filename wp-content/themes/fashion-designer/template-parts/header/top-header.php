				...
				<div class="row">
					<div class="offset-lg-1 col-lg-2 col-md-3 icon-ctr">
						<?php if(class_exists('woocommerce')){ ?>
				          	<span class="cart_no">
				            	<a href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_attr_e( 'shopping cart','fashion-designer' ); ?>"><i class="fas fa-shopping-basket"></i><span class="screen-reader-text"><?php esc_attr_e( 'shopping cart','fashion-designer' );?></span></a>
